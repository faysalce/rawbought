                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group floating-static-group floating-static-style-2">
                                            ...
                                            <input type="text" id="fname" class="form-control floating-field" required="required" placeholder="Enter first name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group floating-static-group floating-static-style-2">
                                            <label for="lname" class="floating-label f-required">Last Name</label>
                                            <input type="text" id="lname" class="form-control floating-field" required="required" placeholder="Enter Last name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group floating-static-group floating-static-style-2">
                                            ...
                                            <input type="email" id="signup-email" class="form-control floating-field" required="required" placeholder="Enter email address">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group floating-static-group floating-static-style-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group text-center">
                                            <p>
                                                By choosing ‘Create an account’ below you accept the terms of our <a href="">Privacy Policy</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
