			...
			?>
					...
					<div class="cart-item woocommerce-mini-cart-item <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
						...
						?> <div class="cart-item-media">
							...
							echo	 $thumbnail         = apply_filters( 'woocommerce_cart_item_thumbnail', $_product->get_image('large'), $cart_item, $cart_item_key );
						...
						<div class="cart-item-denote">
							<div class="cart-item-denote-header">
								<h6 class="cart-item-title">
									<a href="<?php echo $product_permalink; ?>"><?php 
									$productParent = wc_get_product( $_product->get_parent_id() );
									
									echo $productParent->get_name(); ?></a>
								</h6>
