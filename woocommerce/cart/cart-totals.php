...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<table class="table table-cart-total mb-0 ">
		<tbody>
			<tr class="cart-subtotal">
				<th scope="row">Subtotal</th>
				<td>
					<span data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>" class="order-summary-emphasis"><?php wc_cart_totals_subtotal_html(); ?></span>
				</td>
			</tr>
		...
		<tfoot>
			...
			<tr>
				...
				<td>
					<span data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>" class="payment-due-price"><?php wc_cart_totals_order_total_html(); ?></span>
				</td>
			</tr>
