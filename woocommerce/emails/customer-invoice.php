                                                                ...
                                                                <tr>
                                                                    <td style="font-family:'Maison Neue','Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;font-size: 14px; line-height: 24px; font-weight: normal; font-style: normal; color:#010101; text-align: center;">
                                                                        <a href="<?php echo home_url();?>" target="_blank">
                                                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-dark.jpg" alt="Rawbought" style="width: 260px; display: block; margin-left: auto;margin-right:auto;">
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:100%">
                                                                                        <td>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <table cellpadding="0" cellspacing="0" border="0" style="min-width:100%;max-width:100%">
                                                                                                        ...
                                                                                                        if ($order->get_customer_note()) {
                                                                                                            ?>
                                                                                                            <tr>
                                                                                                                <th style="font-family:'Maison Neue','Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;font-size:15px; line-height:20px;font-weight:500;font-style:normal;color:#010101;text-transform: uppercase"><?php esc_html_e('Note:', 'woocommerce'); ?></th>
                                                                                                                <td style="font-family:'Maison Neue','Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;font-size:15px; line-height:20px;font-weight:normal;font-style:normal;color:#010101;text-align:right"><?php echo wp_kses_post(nl2br(wptexturize($order->get_customer_note()))); ?></td>
                                                                                                            </tr>
                                                                                                        <?php
                                                                                                        }
                                                                                                        ?>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="font-family:'Maison Neue','Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;font-size: 13px; line-height: 18px; font-weight: normal; font-style: normal; color:#010101; text-align: center;">
                                                                                                <p style="font-family:'Maison Neue','Helvetica Neue',Helvetica,Arial,Verdana,sans-serif;font-size: 13px; line-height: 18px; font-weight: normal; font-style: normal; color:#010101;">
                                                                                                    ...
                                                                                                    <a href="<?php echo get_permalink(get_page_by_path('terms-and-conditions'));?>" style="color:#010101">Terms & Conditions&nbsp;</a><span>|</span>
                                                                                                    <a href="<?php echo get_permalink(get_page_by_path('faq'));?>" style="color:#010101">FAQ</a>
                                                                                               </p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
