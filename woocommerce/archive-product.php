                        ...
                        <div class="dropdown dropdown-sort">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="sortDropdown">
                                <a class="dropdown-item <?php if (isset($_REQUEST['orderByPrice']) && $_REQUEST['orderByPrice'] == 'price-low-high') {
                                                            echo 'active';
                                                        } ?>" href="<?php  if(is_tax('product_cat')){echo get_term_link($current_term );} ?>/?orderByPrice=price-low-high">Price: Low to High</a>
                                <a class="dropdown-item <?php if (isset($_REQUEST['orderByPrice']) && $_REQUEST['orderByPrice'] == 'price-high-low') {
                                                            echo 'active';
                                                        } ?>" href="<?php  if(is_tax('product_cat')){echo get_term_link($current_term );} ?>/?orderByPrice=price-high-low">Price: High to Low</a>
                            </div>
                        </div>
                    </div>
                </div>
